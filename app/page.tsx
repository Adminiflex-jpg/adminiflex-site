        ...
        <div className="relative max-w-6xl mx-auto px-4 md:px-6 py-16 md:py-24 grid gap-10 md:grid-cols-2 items-center">
          <div>
            ...
            <p className="mt-4 text-lg text-zinc-700 max-w-prose">
              ...
              Start met een gratis proefperiode van 30 dagen.
            </p>

            {/* CTA primair → naar aanmeldformulier */}
          ...
          {[
            {
              ...
              price: "€9,95",
              features: [
                "Compleet boekhouden & BTW-aangifte",
                "Bankkoppeling (PSD2)",
                "scan & herken (OCR) voor inkoopfacturen",
                "1 administratie",
                "1 gebruiker",
                "Tot 250 facturen per maand",
              ],
            },
            {
              name: "Plus",
              ...
              features: [
                "Alles van Basic",
                "Leden- en Voorraadbeheer",
                "Cashflow planning",
                "Onberkte aantal inkoopfacturen per maand",
                "2 gebruikers",
                "Meer uitgebreide rapportages",
              ],
            },
            {
              name: "Pro",
              ...
              features: [
                ...
                "API & Webhooks voor koppelingen",
                "Tot 5 gebruikers",
                "Meerdere administraties beheren",
                "Openstaande posten beheren",
              ],
            },
          ].map((p, i) => (
            <div
              ...
              className={`rounded-xl border bg-white p-6 ${
                i === 1 ? "shadow-lg border-emerald-400" : ""
              }`}
            >
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            ...
            <p className="mt-1 text-white/90">
              Heeft u vragen of wilt u meer informatie over AdminiFlex?
              Neem gerust contact met ons op en wij denken graag met u mee over de beste oplossing voor uw organisatie.
            </p>

            {/* Alleen één knop: Neem contact op */}
            <div className="mt-6">
              <a
                href="/contact"
